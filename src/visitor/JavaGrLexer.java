...
public class JavaGrLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"STRING_VAL", "CHAR_VAL", "INT_VAL", "FLOAT_VAL", "DOUBLE_VAL", "DO_", 
			"FLOAT", "INT", "DOUBLE", "STRING", "CHAR", "BOOL", "PUBLIC", "CLASS", 
			"TRUE", "FALSE", "EQUAL", "NOT_EQUAL", "GREATER", "LESS", "GREATER_EQUAL", 
