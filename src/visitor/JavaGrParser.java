...
public class JavaGrParser extends Parser {
	...
	public static final int
		NUMBER=1, CHARACTER=2, STRING_VAL=3, CHAR_VAL=4, INT_VAL=5, FLOAT_VAL=6, 
		DOUBLE_VAL=7, DO_=8, FLOAT=9, INT=10, DOUBLE=11, STRING=12, CHAR=13, BOOL=14, 
		PUBLIC=15, CLASS=16, TRUE=17, FALSE=18, EQUAL=19, NOT_EQUAL=20, GREATER=21, 
		LESS=22, GREATER_EQUAL=23, LESS_EQUAL=24, BRACKET_L=25, BRACKET_R=26, 
		...
		WHILE=40, SEMICOLON=41, COMMA=42, IMPORT=43, PACKAGE=44, RETURN=45, PRIVATE_NEW_VAR=46, 
		PROTECTED_NEW_VAR=47, STATIC_VAR=48, OR=49, AND=50, VOID=51, IDENTIFIER=52, 
		WS=53;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, null, null, null, null, "'do'", "'float'", "'int'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "NUMBER", "CHARACTER", "STRING_VAL", "CHAR_VAL", "INT_VAL", "FLOAT_VAL", 
			"DOUBLE_VAL", "DO_", "FLOAT", "INT", "DOUBLE", "STRING", "CHAR", "BOOL", 
			"PUBLIC", "CLASS", "TRUE", "FALSE", "EQUAL", "NOT_EQUAL", "GREATER", 
			...
			"COMMA", "IMPORT", "PACKAGE", "RETURN", "PRIVATE_NEW_VAR", "PROTECTED_NEW_VAR", 
			"STATIC_VAR", "OR", "AND", "VOID", "IDENTIFIER", "WS"
		};
	}
